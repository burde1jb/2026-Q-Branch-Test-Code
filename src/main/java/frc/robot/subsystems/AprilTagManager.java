        ...
        { return
          new SelectCommand<>(
              ...
              Map.ofEntries(
                  ...
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(6,0.0,ReefWidthCenterOffset + ReefOffsetLeft,true)))),
    
                  Map.entry(7, new PrintCommand("Command 7 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(7,0,ReefWidthCenterOffset + ReefOffsetLeft,true)))),
                  
                  Map.entry(8, new PrintCommand("Command 8 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(8,0,ReefWidthCenterOffset + ReefOffsetLeft,true)))),
    
                  Map.entry(9, new PrintCommand("Command 9 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(9,0,ReefWidthCenterOffset + ReefOffsetLeft,true)))),
                  Map.entry(10, new PrintCommand("Command 10 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(10,0,ReefWidthCenterOffset + ReefOffsetLeft,true)))),
                  Map.entry(11, new PrintCommand("Command 11 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(11,0,ReefWidthCenterOffset + ReefOffsetLeft,true)))),

                  Map.entry(17, new PrintCommand("Command 17 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(17,0,ReefWidthCenterOffset + ReefOffsetLeft,true)))),
                  Map.entry(18, new PrintCommand("Command 18 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(18,0,ReefWidthCenterOffset + ReefOffsetLeft,true)))),
                  Map.entry(19, new PrintCommand("Command 19 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(19,0,ReefWidthCenterOffset + ReefOffsetLeft,true)))),
                  Map.entry(20, new PrintCommand("Command 20 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(20,0,ReefWidthCenterOffset + ReefOffsetLeft,true)))),
                  Map.entry(21, new PrintCommand("Command 21 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(21,0,ReefWidthCenterOffset + ReefOffsetLeft,true)))),
                  Map.entry(22, new PrintCommand("Command 22 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(22,0,ReefWidthCenterOffset + ReefOffsetLeft,true))))
        ...
        { return
          new SelectCommand<>(
              ...
              Map.ofEntries(
                  ...
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(6,0.0,ReefWidthCenterOffset - ReefOffset,false)))),
    
                  Map.entry(7, new PrintCommand("Command 7 Right was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(7,0,ReefWidthCenterOffset - ReefOffset,false)))),
                  
                  Map.entry(8, new PrintCommand("Command 8 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(8,0,ReefWidthCenterOffset - ReefOffset,false)))),
    
                  Map.entry(9, new PrintCommand("Command 9 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(9,0,ReefWidthCenterOffset - ReefOffset,false)))),
                  Map.entry(10, new PrintCommand("Command 10 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(10,0,ReefWidthCenterOffset - ReefOffset,false)))),
                  Map.entry(11, new PrintCommand("Command 11 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(11,0,ReefWidthCenterOffset - ReefOffset,false)))),

                  Map.entry(17, new PrintCommand("Command 17 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(17,0,ReefWidthCenterOffset - ReefOffset,false)))),
                  Map.entry(18, new PrintCommand("Command 18 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(18,0,ReefWidthCenterOffset - ReefOffset,false)))),
                  Map.entry(19, new PrintCommand("Command 19 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(19,0,ReefWidthCenterOffset - ReefOffset,false)))),
                  Map.entry(20, new PrintCommand("Command 20 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(20,0,ReefWidthCenterOffset - ReefOffset,false)))),
                  Map.entry(21, new PrintCommand("Command 21 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(21,0,ReefWidthCenterOffset - ReefOffset,false)))),
                  Map.entry(22, new PrintCommand("Command 22 was selected!")
                  .alongWith(new C_Align(AprilTagManager.getOffSet90Loc(22,0,ReefWidthCenterOffset - ReefOffset,false))))
